...
public class MybatisPlusGenerator {
  public static void main(String[] args) {
    ...
    FastAutoGenerator
        .create("jdbc:mysql://xxx:3306/magic-box?serverTimezone=Asia/Shanghai&useSSL=false", "magic-box",
            "eT2nDtDhYbjTyMeH")
        // 全局配置
        ...
        .strategyConfig(builder -> {
          builder.addInclude(listTable) // 设置需要生成的表名
              .addTableSuffix(String.valueOf(listTableSuffix))
              .addTablePrefix(String.valueOf(listTablePrefix))// 设置过滤表前缀
